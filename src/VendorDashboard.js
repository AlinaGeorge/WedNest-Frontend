  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col w-3/4 p-6" style={{ backgroundImage: "url('/vendorbg.jpeg')", backgroundSize: "cover", backgroundPosition: "center" }}>
          <div className="grid grid-cols-3 gap-6">
            ...
            {/* ✅ Palm Green Button */}
            <button
              className="p-6 rounded-lg bg-green-600 text-white shadow-md h-[250px] text-xl font-semibold hover:bg-green-700 transition"
